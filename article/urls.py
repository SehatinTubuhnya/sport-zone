...
from article.views import add_news_entry_ajax, edit_news_entry_ajax, get_news_entry_ajax
...
urlpatterns = [
    ...
    path('get-news-ajax/<uuid:news_id>', get_news_entry_ajax, name='get-news-ajax'),
